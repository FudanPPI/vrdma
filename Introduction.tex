...
\begin{itemize}
	...
	\item A system, called \sys,~is implemented and evaluated. The results show that \sys maintains high performance with less than 5\% slowdown for simple network operation evalutions and similar performance for real applications compared with those of SR-IOV and \native.  .
\end{itemize}
