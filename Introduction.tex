...
RDMA (remote direct memory access) is a high-performance network,  with high throughput, low latency and low CPU load. Thus, RDMA is widely adopted in data-centers for various fields, such as supercomputing, artificial intelligence, and big data processing. 
