...
In userspace, vRNICs are virtualized and mapped into isolated SR-IOV VFs in the physical RNIC. The driver of vRNICs is unified for containers and VMs, and vRNICs' RDMA resources(including data) are mapped with applications to get high performance. The virtual layer contructs each vRNIC and manages the virtual RDMA network.
% 测试结果量化表示
