...
The results of two-sided operation are shown in Figure~\ref{fig:send-bw}, and the one of one-sided operation are shown in Figure~\ref{fig:write-bw}. For one-sided operation \sys in virtual machine has readched to 0.87x and 0.94x of native RDMA and SR-IOV. The container scenario gets 0.84x and 0.91x lower throughput than native RDMA and SR-IOV. For two-sided operation, The virtual machine scenario has 0.86x and 0.89x lower throughput than native RDMA and SR-IOV. In the container scenario, the throughput are 0.85x and 0.91x that of the native RDMA and SR-IOV.
