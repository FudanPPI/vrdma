...
The results of two-sided operation are shown in Figure~\ref{fig:send-bw}, and the one of one-sided operation are shown in Figure~\ref{fig:write-bw}. As the data show, no matter for VMs or containers, the throughput of \sys is similar to SR-IOV and close to native RDMA.
