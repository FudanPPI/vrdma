...
% 4.3.3 数据阶段
% 数据路径发生在连接建立后，主要是对本地/远端 MR中的内容执行收发操作。RDMA的数据路径包括图中的D1和D2。
\subsubsection{Data Phase}
The data phase is after the RDMA connection is established and about how to send/receive the content in the local/remote MR buffers. 
