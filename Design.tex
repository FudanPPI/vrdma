...
URN Core instantiates a vRNIC once receiving the request from the application in the guest. Instantiating vRNIC mainly includes 4 major work: 1) initializing vRNIC attributes, 2) binding the vRNIC to the physical RNIC, 3) building the message channel between the vRNIC frontend and backend, and 4) isolating the vRNIC instances.
